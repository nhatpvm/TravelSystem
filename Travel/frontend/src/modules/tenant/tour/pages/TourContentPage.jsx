          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            {tab === 'policies' && (
              <>
                ...
                <label className="space-y-2 block"><span className="text-[11px] font-black uppercase tracking-widest text-slate-400">Điều kiện áp dụng</span><textarea name="policyJson" value={form.policyJson} onChange={handleFieldChange} rows={3} className="w-full rounded-[1.5rem] border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium outline-none resize-none" /></label>
              </>
            )}
