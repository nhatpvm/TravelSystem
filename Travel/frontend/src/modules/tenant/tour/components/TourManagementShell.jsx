...
import TourManagementSecondaryNav from './TourManagementSecondaryNav';

const TourManagementShell = ({
  pageKey = 'overview',
  title,
  subtitle,
  error = '',
  ...
  <div className="space-y-8">
    ...
    <TourManagementSecondaryNav currentKey={pageKey} />
...
export default TourManagementShell;
