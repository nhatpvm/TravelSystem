...
import TrainManagementSecondaryNav from './TrainManagementSecondaryNav';

const TrainManagementPageShell = ({
  pageKey = 'overview',
  title,
  subtitle,
  notice = '',
  ...
  <div className="p-8 space-y-8">
    ...
    <TrainManagementSecondaryNav currentKey={pageKey} />
...
export default TrainManagementPageShell;
