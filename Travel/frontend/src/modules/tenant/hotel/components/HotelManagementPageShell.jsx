...
import HotelManagementSecondaryNav from './HotelManagementSecondaryNav';

const HotelManagementPageShell = ({
  pageKey = 'overview',
  title,
  subtitle,
  notice = '',
  ...
  <div className="p-8 space-y-8">
    ...
    <HotelManagementSecondaryNav currentKey={pageKey} />
...
export default HotelManagementPageShell;
