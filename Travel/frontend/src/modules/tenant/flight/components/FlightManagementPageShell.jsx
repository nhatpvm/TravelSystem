...
import FlightManagementSecondaryNav from './FlightManagementSecondaryNav';

const FlightManagementPageShell = ({
  pageKey = 'overview',
  title,
  subtitle,
  notice = '',
  ...
  <div className="p-8 space-y-8">
    ...
    <FlightManagementSecondaryNav currentKey={pageKey} />
...
export default FlightManagementPageShell;
