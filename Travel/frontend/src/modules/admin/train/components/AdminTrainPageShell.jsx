...
import AdminTrainSecondaryNav from './AdminTrainSecondaryNav';

const AdminTrainPageShell = ({
  pageKey = 'overview',
  title,
  subtitle,
  tenants = [],
...
export default AdminTrainPageShell;
