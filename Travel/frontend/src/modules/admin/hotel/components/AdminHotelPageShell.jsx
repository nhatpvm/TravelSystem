...
import AdminHotelSecondaryNav from './AdminHotelSecondaryNav';

const AdminHotelPageShell = ({
  pageKey = 'overview',
  title,
  subtitle,
  tenants = [],
  ...
  <div className="p-8 space-y-8">
    ...
    <AdminHotelSecondaryNav currentKey={pageKey} />

    {selectedTenant ? (
      <div className="rounded-2xl border border-sky-100 bg-sky-50 px-5 py-4 text-sm font-bold text-sky-700">
        Đang quản lý dữ liệu khách sạn cho tenant: {selectedTenant.name}
      </div>
    ) : null}
...
export default AdminHotelPageShell;
