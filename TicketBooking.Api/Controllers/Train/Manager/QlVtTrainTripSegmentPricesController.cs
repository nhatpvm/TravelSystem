// FILE #298: TicketBooking.Api/Controllers/QlVtTrainTripSegmentPricesController.cs
...
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/qlvt/train/trip-segment-prices")]
[Authorize(Roles = $"{RoleNames.Admin},{RoleNames.QLVT}")]
public sealed class QlVtTrainTripSegmentPricesController : ControllerBase
{
    private readonly AppDbContext _db;
    private readonly ITenantContext _tenantContext;

    public QlVtTrainTripSegmentPricesController(AppDbContext db, ITenantContext tenantContext)
    {
        _db = db;
