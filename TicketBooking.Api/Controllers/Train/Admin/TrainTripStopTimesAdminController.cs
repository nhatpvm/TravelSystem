// FILE #288: TicketBooking.Api/Controllers/TrainTripStopTimesAdminController.cs
...
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/admin/train/trip-stop-times")]
[Authorize(Roles = RoleNames.Admin)]
public sealed class TrainTripStopTimesAdminController : ControllerBase
{
    private readonly AppDbContext _db;
    private readonly ITenantContext _tenantContext;

    public TrainTripStopTimesAdminController(AppDbContext db, ITenantContext tenantContext)
    {
        _db = db;
