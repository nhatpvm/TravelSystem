// FILE #279: TicketBooking.Api/Controllers/BusTripSegmentPricesAdminController.cs
...
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/admin/bus/trip-segment-prices")]
[Authorize(Roles = RoleNames.Admin)]
public sealed class BusTripSegmentPricesAdminController : ControllerBase
{
    private readonly AppDbContext _db;
    private readonly ITenantContext _tenantContext;

    public BusTripSegmentPricesAdminController(AppDbContext db, ITenantContext tenantContext)
    {
        _db = db;
