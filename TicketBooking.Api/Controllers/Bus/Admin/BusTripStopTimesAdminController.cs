// FILE #278: TicketBooking.Api/Controllers/BusTripStopTimesAdminController.cs
...
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/admin/bus/trip-stop-times")]
[Authorize(Roles = RoleNames.Admin)]
public sealed class BusTripStopTimesAdminController : ControllerBase
{
    private readonly AppDbContext _db;
    private readonly ITenantContext _tenantContext;

    public BusTripStopTimesAdminController(AppDbContext db, ITenantContext tenantContext)
    {
        _db = db;
        ...
        CancellationToken ct = default)
    {
        ...
        var pickupCounts = ids.Count == 0
            ...
            : await _db.BusTripStopPickupPoints.IgnoreQueryFilters()
                .Where(x => ids.Contains(x.TripStopTimeId) && !x.IsDeleted)
        ...
        CancellationToken ct = default)
    {
        ...
        var pickupPoints = await _db.BusTripStopPickupPoints.IgnoreQueryFilters()
            .Where(x => x.TripStopTimeId == id && !x.IsDeleted)
